...
//$user2 = new User('Kolya', 'nik@gmail.com', 'Qwerty654321', 'Ukrain, Odessa');
$userTemplateResponse = new userTemplateResponse($user);
$userJsonResponse = new UserJsonResponse($user);
//$userTemplateResponse($user);
//$userJsonResponse($user);
$response = new App\Response();
$response->get($userJsonResponse);
$response->get($userTemplateResponse);
